...
target.package_product_dependencies.delete_if { |dep| dep.product_name == 'StanokAgents' }
...
dependency.product_name = 'StanokAgents'
...
project.save
puts 'linked local package product StanokAgents into target Stanok'
